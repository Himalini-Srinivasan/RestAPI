package com.example.democc1.controller;

import org.springframework.web.bind.annotation.RestController;

import com.example.democc1.model.ServiceBooking;
import com.example.democc1.service.ServiceBookingService;
...
public class ServiceBookingController {
    ...
    public ResponseEntity<String> deleteBooking(@PathVariable Long bookingId) {
        ...
        if (existingBookingOptional.isPresent()) {
            ...
            return ResponseEntity.notFound().build(); // If booking with given ID not found
        }
    }
